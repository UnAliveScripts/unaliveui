...
return function(self, props)
    ...
    local frame = create("ScrollingFrame")({
        ...
        ClipsDescendants = false, ScrollBarImageColor3 = Color3.fromRGB(150, 150, 160),
    ...
    local structures = { Frame = frame.__instance, Layout = frame.__instance:FindFirstChild("Layout") }
    local obj = { Type = "Page", Theme = self and self.Theme, Structures = structures, __instance = frame.__instance }
