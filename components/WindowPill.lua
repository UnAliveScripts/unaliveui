...
return function(self, props)
	...
	body.MouseEnter:Connect(function()
		...
		ct = TS:Create(body.__instance, TweenInfo.new(0.4, Enum.EasingStyle.Exponential), { ImageTransparency = 0.15 })
		ct:Play()
	end)
	body.MouseLeave:Connect(function()
		if ct then ct:Cancel() end
		ct = TS:Create(body.__instance, TweenInfo.new(0.4, Enum.EasingStyle.Exponential), { ImageTransparency = 0.5 })
		ct:Play()
	end)
