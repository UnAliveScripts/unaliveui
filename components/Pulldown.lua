	...
	local c = C("Frame")({
		...
		C("Frame")({
			...
			C("ScrollingFrame")({
				...
				TopImage = "rbxasset://textures/ui/ScrollBar/top.png",
				MidImage = "rbxasset://textures/ui/ScrollBar/mid.png",
