local components = {}
local names = { "Window", "Button", "Toggle", "Slider", "Label", "TextField", "Stepper", "StepperPill", "Pulldown", "TrailingAccessories", "Notification", "Alert", "WindowPill", "Icon", "Page", "Row", "EditMenu" }
