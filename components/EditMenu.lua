...
return function(self, props)
	...
	local ind = Instance.new("Frame"); ind.Size = UDim2.fromOffset(36, 36); ind.BackgroundColor3 = Color3.fromRGB(3, 3, 3); ind.BackgroundTransparency = 0; ind.Parent = content; Instance.new("UICorner", ind).CornerRadius = UDim.new(1, 0)
