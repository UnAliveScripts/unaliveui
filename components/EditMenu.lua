--[[
	...
	Selected item shows destructive (red) text, unselected shows white.
	Selection animates with smooth color transitions.
--]]
...
return function(self, props)
	...
	local body = C("Frame")({
		...
		C("Frame")({
			...
			ZIndex = 1,
			C("UICorner")({ CornerRadius = UDim.new(0, 34) }),
			C("UIStroke")({ Color = white, Transparency = 0.88, Thickness = 1 }),
		}),
	...
	for i, item in ipairs(props.Items) do
		...
		hitbox.MouseButton1Click:Connect(function()
			...
			if selectedLabel then
				TS:Create(selectedLabel, tweenInfo, { TextColor3 = normalColor }):Play()
			end
	...
	ind.BackgroundColor3 = dark
	ind.BackgroundTransparency = 0.08
	ind.Parent = content
	...
	ii.ImageColor3 = white
	ii.ScaleType = Enum.ScaleType.Fit
	ii.ZIndex = 3
	ii.Parent = ind

	local obj = { Type = "EditMenu", __instance = body.__instance }
